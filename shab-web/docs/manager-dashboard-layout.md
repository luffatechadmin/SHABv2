# Manager Dashboard Layout Standard

**Version:** 1.0  
**Status:** Authoritative  
**Scope:** Manager Dashboard (`/manager`)

This document defines the strict layout standards for the Manager Dashboard. All future changes must adhere to these rules to maintain consistency.
